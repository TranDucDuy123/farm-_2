...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 18, 2024 lúc 12:37 AM
...
(5, 'Cơ sở Giết mổ E', 'Đường JKL, Quận 4, Cần Thơ', '0908765432', 'Gia cầm', 350, 'Operational');
...
--
ALTER TABLE `user_access_history`
  MODIFY `access_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
